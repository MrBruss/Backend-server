        ...
        <li><a href="#"><i class="fa fa-credit-card"></i> Cards <i class="fas fa-caret-down"></i></a>
          ...
          <div class="dropdown_menu">
              <ul>
                  ...
                  <li><a href="/Public/Cards/Mastercard.html">Master Cards</a></li>
                  <li><a href="/Public/Cards/visa.html"> Visa Cards</a></li>
                  <li><a href="/Public/Cards/Amex.html">Amex Cards</a></li>
                  <li><a href="/Public/Cards/Discover.html">Discover Cards</a></li>
              </ul>
    ...
    <div class="container">
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $3,608.00 </p>
            <p class="text-2">Price: $185 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $5,700.00</p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $10,330.00</p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $16,400.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $22,530.00 </p>
