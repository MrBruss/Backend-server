...
<?php include("../header.php"); ?>  <!-- If the page is inside a folder -->
    ...
    <div class="container">
     <h1 class="heading">CITI LOGs</h1>
     <div class="box-container">

     <div class="box">
        <img src="/Public/img/Citibank.webp" alt="">
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ✅[Email Access]/User Id  ✅[Credit Card Details] ✅[Cookies]</h2>

            <p class="text-1">Balance : $2,065.00 </p>
            <p class="text-2">Price : $135</p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $2,380.00 </p>
            <p class="text-2">Price: $155 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $2,908.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $3,550.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $4,400.00 </p>
            <p class="text-2">Price: $270 </p>
            <p class="text-3">Status: <button class="button1"> AVAILABLE </button></p>
            <a href="/Public/Forms/emailforms.html" class="btn">Buy</a>
     </div>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $6,800.00 </p>
            <p class="text-2">Price: $315 </p>
            <p class="text-3">Status: <button class="button1"> AVAILABLE </button></p>
            <a href="/Public/Forms/emailforms.html" class="btn">Buy</a>
     </div>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $8,500.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $15,400.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $22,500.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $30,400.00 </p>
            <p class="text-2">Price: $715 </p>
            <p class="text-3">Status: <button class="button1"> AVAILABLE </button></p>
            <a href="/Public/Forms/emailforms.html" class="btn">Buy</a>
     </div>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $34,050.00 </p>
            <p class="text-2">Price: $755 </p>
            <p class="text-3">Status: <button class="button1"> AVAILABLE </button></p>
            <a href="/Public/Forms/emailforms.html" class="btn">Buy</a>
     </div>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $37,760.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $40,755.00 </p>
            <p class="text-2">Price: $855 </p>
            <p class="text-3">Status: <button class="button1"> AVAILABLE </button></p>
            <a href="/Public/Forms/emailforms.html" class="btn">Buy</a>
     </div>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $44,500.00 </p>
