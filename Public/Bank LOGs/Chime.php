...
<body>
    ...
    <div class="container">
     <h1 class="heading">Chime LOGs</h1>
     <div class="box-container">

     <div class="box">
        <img src="/Public/img/Chime.png" alt="">
     ...
     <div class="box">
        <img src="/Public/img/Chimebank.png" alt="">
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ✅[Email Access]/User Id  ✅[Credit Card Details] ✅[Cookies]</h2>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $3,770</p>
            <p class="text-2">Price: $210</p>
            <p class="text-3">Status: <button class="button1"> AVAILABLE </button></p>
            <a href="/Public/Forms/emailforms.html" class="btn">Buy</a>
     </div>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $7,150</p>
            <p class="text-2">Price: $355</p>
            <p class="text-3">Status: <button class="button2"> SOLD OUT </button></p>
            <a href="#" class="btn">Buy</a>
     </div>
