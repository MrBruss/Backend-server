...
<?php include("../header.php"); ?>  <!-- If the page is inside a folder -->
    ...
    <div class="container">
     ...
     <div class="box">
        <img src="/Public/img/TDbank.jpg" alt="">
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ✅[Email Access]/User Id  ✅[Credit Card Details] ✅[Cookies]</h2>

            <p class="text-1">Balance: $3,350.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $4,550.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $5,550.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $6,2000.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $7,500.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $8,800.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $9,500.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $18,000.00</p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $26,500.00</p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $40,000.00 </p>
