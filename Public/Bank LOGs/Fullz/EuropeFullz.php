    ...
    <div class="table_responsive">
        <table>
            ...
            <tbody>
                <tr>
                    <td> ITALY Fullz </td>
                    <td> ITALY visa CC Fullz(CVV)x2 </td>
                    <td> 
                ...
                <tr>
                    <td> GERMANY Fullz </td>
                    <td> GERMANY visa CC Fullz(CVV)x10 </td>
                    <td> 
                ...
                <tr>
                    <td> ITALY Fullz </td>
                    <td> ITALY visa CC Fullz(CVV)x10 </td>
                    <td> 
                        <img src="/Public/img/Italy.png" alt="">  
                    </td>
                    <td> $100 </td> 
                ...
                <tr>
                    <td> FRANCH Fullz </td>
                    <td> FRANCH visa CC Fullz(CVV)x15 </td>
                    <td> 
                        <img src="/Public/img/France.webp" alt="">  
                    </td>
                    <td> $120 </td> 
                    <td> 
                        <span class="action_btn">
                ...
                <tr>
                    <td> FRANCE Fullz </td>
                    <td> FRANCE visa CC Fullz(CVV)x5 </td>
                    <td> 
                        <img src="/Public/img/France.webp" alt="">  
                    </td>
                    <td> $88 </td> 
