...
<body>
  ...
  <?php include("../header.php"); ?>  <!-- If the page is inside a folder -->
    ...
    <nav class="navbar">
      ...
      <ul>
        ...
        <li><a href="#"><i class="fa fa-university" aria-hidden="true"></i> Bank Logs <i class="fas fa-caret-down"></i></a>
          ...
          <div class="dropdown_menu">
              <ul>
                  <li><a href="chase.html">Chase Banks</a></li>
    ...
    <div class="container">
     <h1 class="heading">Chase Bank</h1>
     <div class="box-container">

     <div class="box">
        <img src="/Public/img/chase.jpg" alt="">
     ...
     <div class="box">
        <img src="/Public/img/chase1.jpg" alt="">
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ✅[Email Access]/User Id  ✅[Credit Card Details] ✅[Cookies]</h2>

            <p class="text-1">Balance: $1,055.00 </p>
     ...
     <div class="box">
        <img src="/Public/img/chasebank.jpg" alt="">
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ✅[Email Access]/User Id  ✅[Credit Card Details] ✅[Cookies]</h2>
