...
<?php include("../header.php"); ?>  <!-- If the page is inside a folder -->
          ...
          <div class="dropdown_menu">
              <ul>
               ...
               <ul>
                ...
                <li><a href="/Public/Bank LOGs/RBC.v">RBC Banks</a></li>
    ...
    <div class="container">
     <h1 class="heading">Wells Fargo Bank</h1>
     <div class="box-container">

     <div class="box">
        <img src="/Public/img/wellsfargo.jpg" alt="">
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ✅[Email Access]/User Id  ✅[Credit Card Details] ✅[Cookies]</h2>

            <p class="text-1">Balance : $1,200.00 </p>
            <p class="text-2">Price : $140</p>
     ...
     <div class="box">
        <img src="/Public/img/Wellsfargo1.png" alt="">
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ✅[Email Access]/User Id  ✅[Credit Card Details] ✅[Cookies]</h2>

            <p class="text-1">Balance: $2,000.00 </p>
            <p class="text-2">Price: $160</p>
            <p class="text-3">Status: <button class="button1"> AVAILABLE </button></p>
            <a href="/Public/Forms/emailforms.html" class="btn">Buy</a>
     </div>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $2,850.07 </p>
            <p class="text-2">Price: $180</p>
            <p class="text-3">Status: <button class="button1"> AVAILABLE </button></p>
            <a href="/Public/Forms/emailforms.html" class="btn">Buy</a>
     </div>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $3,220.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $4,000.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $5,500.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $6,015.00</p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $8,000.00</p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $10,800.00 </p>
            <p class="text-2">Price: $450</p>
            <p class="text-3">Status: <button class="button2"> SOLD OUT </button></p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $15,500.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $18,850.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $22,000.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $26,700.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $30,500.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $34,000.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $37,750.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $40,700.00 </p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $44,510.00</p>
     ...
     <div class="box">
        ...
        <h2>✅[Online Access] ✅[Account/Routine Number] ✅[Name And Address] ✅ SSN - PHONE 
            ...
            <p class="text-1">Balance: $48,200.00 </p>
