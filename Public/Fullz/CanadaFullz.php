...
<?php include("../header.php"); ?>  <!-- If the page is inside a folder -->
    <!-- Add this to every page where you want the top bar -->
      ...
      <li><a href="#"><i class="fa fa-credit-card"></i> Cards <i class="fas fa-caret-down"></i></a>
        ...
        <div class="dropdown_menu">
            <ul>
                ...
                <li><a href="/PublicCards/Mastercard.php">Master Cards</a></li>
                <li><a href="/PublicCards/visa.php"> Visa Cards</a></li>
                <li><a href="/PublicCards/Amex.php">Amex Cards</a></li>
                <li><a href="/PublicCards/Discover.php">Discover Cards</a></li>
            </ul>
      ...
      <li><a href="#"><i class="fa fa-university" aria-hidden="true"></i> Bank Logs <i class="fas fa-caret-down"></i></a>
        ...
        <div class="dropdown_menu">
            <ul>
                ...
                <li><a href="/PublicBank LOGs/Boa.php">BOA Banks</a></li>
                <li><a href="/PublicBank LOGs/Citi.php">Citi Banks</a></li>
                <li><a href="/PublicBank LOGs/wellsfargo.php">Wells Fargo Banks</a></li>
                <li><a href="/PublicBank LOGs/TD.php">TD Banks</a></li>
                <li><a href="/PublicBank LOGs/Huntington.php">Huntington Banks</a></li>
                <li><a href="/PublicBank LOGs/Chime.php">Chime Banks</a></li>
                <li><a href="/PublicBank LOGs/Suntrust.php">Suntrust Banks</a></li>
                <li class="hover-me"><a href="#">Canadian Bank Log <i class="fas fa-angle-right"></i></a>
                  <div class="dropdown_menu-1">
             <ul>
              <li><a href="/PublicBank LOGs/Scotia.php">Scotia Banks</a></li>
              <li><a href="/PublicBank LOGs/RBC.php">RBC Banks</a></li>
              <li><a href="/PublicBank LOGs/TDCanada.php">TD Banks</a></li>
              <li><a href="/PublicBank LOGs/BMO.php">BMO Banks</a></li>
            </ul>
                </li>
                <li class="hover-me"><a href="#">UK Bank Logs <i class="fas fa-angle-right"></i></a>
                  <div class="dropdown_menu-1">
                    <ul>
                     <li><a href="/PublicBank LOGs/Lollyds.php">Lollyds Banks</a></li>
                     <li><a href="/PublicBank LOGs/Hsbc.php">Hsbc UK Banks</a></li>
                     <li><a href="/PublicBank LOGs/Halifax.php">Halifax Banks</a></li>
                     <li><a href="/PublicBank LOGs/Barclays.php">Barclays Banks</a></li>
                   </ul>
                </li>
            </ul>
    ...
    <div class="table_responsive">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td> CANADA Fullz </td>
                    <td> CANADA visa CC Fullz(CVV)x5 </td>
                    <td> 
                        <img src="/Public/img/Canada logo.jpg" alt="">  
                    </td>
                    <td> $88 </td> 
                ...
                <tr>
                    <td> CANADA Fullz </td>
                    <td> CANADA visa CC Fullz(CVV)x2 </td>
                    <td> 
                        <img src="/Public/img/Canada logo.jpg" alt="">  
                    </td>
                    <td> $75 </td> 
                ...
                <tr>
                    <td> CANADA Fullz </td>
                    <td> CANADA visa CC Fullz(CVV)x15 </td>
                    <td> 
                        <img src="/Public/img/Canada logo.jpg" alt="">  
                    </td>
                    <td> $120 </td> 
