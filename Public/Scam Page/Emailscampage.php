...
<?php include("../header.php"); ?>  <!-- If the page is inside a folder -->
    ...
    <div class="table_responsive">
        <table>
            ...
            <tbody>
                <tr>
                    <td> New Office Link(Company Logo and Background) </td>
                ...
                <tr>
                    <td>New China ScamPage For All Domains </td>
                    <td> Domain Antibot And Panel </td>
                    <td> $145 </td> 
                    <td> 
                        <span class="action_btn">
                            <a href="/Public/Forms/emailforms.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Buy </a>
                ...
                <tr>
                    <td> Xfinity/Comcast Scam Page </td>
                    <td> AntiBot </td>
                    <td> $65 </td> 
                    <td> 
                        <span class="action_btn">
